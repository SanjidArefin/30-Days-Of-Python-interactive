# Day 1 Practice: Introduction

"""
Read helloworld.py first.

This file is for practice. Complete each task by writing your own Python code
under the task comment.
"""
...
3. If the path is confusing, open File Explorer, go to the project folder,
   click the address bar at the top, copy the path, and paste it after cd.
...
# Practice 1: print()
# ---------------------------------------------------------------------------
# Write a print statement for each task.
...
# ---------------------------------------------------------------------------
# Use print() and the operators you saw in helloworld.py.
...
# Practice 3: type()
# ---------------------------------------------------------------------------
# Use print(type(value)) to check each data type.
...
# Challenge
# ---------------------------------------------------------------------------
# First write your guess in a comment. Then write code to check the answer.
